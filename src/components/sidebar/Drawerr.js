...
function Drawerr(props) {
 ...
 //action functions on clicking button..
  ...
  const orders=()=>
             {
              props.fxn && props.fxn();
              user?._id? navigate(`/orderstatus/${user?._id}`): navigate("/login")
            }
  const favorite=()=>
             {
              props.fxn && props.fxn();
  ...
  const options=[
    ...
    {icon:<AccountCircleIcon/>,action:myAccount,title:"Your Account",category:""},
                   ...
                   <ListItem  sx={{padding:0,margin:"0px"}}>
                      ...
                      {option.value&&
                         <ListItemIcon  sx={{display:"flex",justifyContent:"center",position:"relative"}}>
                             ...
                             {subCategories?
                             <Sublist 
                                 sx={{display:subCategories===option.value?"block":"none"}} 
                                 onMouseLeave={()=>setSubcategories(0)}
                              >
