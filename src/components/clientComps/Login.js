...
import { emailfxn, pswdfxn } from "../API/validations";
...
export default function Login() {
    ...
    const [pswdVal,setPassVal]=useState(false)
    ...
    <OuterBox>
     <MainBox theme={theme}>
              ...
              <Grid container spacing={1}>
                   ...
                   <Grid item xs={12} sx={{}}>
                       <TxtfieldCstm error={pswdVal} autoComplete='none' type="password" label="Password" placeholder="Enter your password.." fxn={(e)=>pswdfxn(e,setPass,setPassVal)} helperText={"Password is too short"}/>
                   </Grid>
                   <Grid item xs={12}>
