...
function ShopingCard() {
  ...
  return (
    <Frame sx={{marginTop:"0px",display:"flex",flexDirection:"column",alignItems:"center"}}>
        <ProductHeading sx={{marginBottom:'10px',textAlign:"center"}}>
          My Shoping Card... 
        </ProductHeading>
        <MainBox sx={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",width:"100%",fontWeight:700,color:'#2d0202',marginBottom:"10px"}}>
