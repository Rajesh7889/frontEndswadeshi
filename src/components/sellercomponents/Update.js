...
export default function AddProducts(){
    ...
    return(
        <OuterBox>
           <MainBox sx={{backgroundColor:"white"}}>
                 { errMsg!==""&&
                     <ErrorBox >
              ...
              <Grid container spacing={1}>
                 ...
                 <Grid item xs={12}>
                   <Button1 type="submit" variant="contained" sx={{backgroundColor:"rgb(34, 22, 22)",":hover":{color:"white",backgroundColor:"rgb(53, 2, 2)"}}} onClick={updateProduct} fullWidth> Update Product </Button1>
                 </Grid>
