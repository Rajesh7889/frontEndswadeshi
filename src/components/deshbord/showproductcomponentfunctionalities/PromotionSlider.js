             ...
             <Box>
                {
                  props.promote[itmIndx] ?
                   <PromotionBox theme={theme}>
                     <PromotionImage theme={theme} src={props.promote[itmIndx].imgs[0].url} onClick={()=>props.productDetails(props.promote[itmIndx]._id)}></PromotionImage>
                       <Promotionproductdtls theme={theme} >
                             ...
                             <Cost price={props.promote[itmIndx].price} discount={props.promote[itmIndx]?.discount}/>
